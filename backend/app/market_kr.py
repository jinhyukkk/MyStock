...
SECTOR_OF: dict[str, str] = {
    # 삼성전자·SK하이닉스는 시총이 다른 반도체 종목을 압도해 같은 섹터에 두면 트리맵 칸을
    # 이 둘이 통째로 차지한다 — 두 회사만 자기 이름을 섹터로 둬 별도 칸으로 뗀다.
    "005930": "삼성전자", "000660": "SK하이닉스",
    # 반도체·전자부품
    "402340": "반도체·전자부품", "009150": "반도체·전자부품", "042700": "반도체·전자부품",
    "007660": "반도체·전자부품", "011070": "반도체·전자부품",
    # 자동차
